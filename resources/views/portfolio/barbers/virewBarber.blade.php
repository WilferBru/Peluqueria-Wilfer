<div class="modal fade" id="viewBarber<?=$num?>" role="dialog" style="margin-top: 67px;">
        ...
        <div class="modal-content bg-light">
            ...
            <div class="modal-body bg-white">
                <div class="single_pricing_item container">
                    <center><img class="bd-placeholder-img rounded-circle" src="{{ Storage::url($fact->photo) }}" width="200" height="200" alt=""></center>
